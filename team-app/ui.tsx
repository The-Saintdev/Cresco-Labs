import { ActivityIndicator, StyleSheet, Text, TouchableOpacity, View, useColorScheme, type StyleProp, type ViewStyle } from 'react-native'
import { FileText, Film, Image as ImageIcon, type LucideIcon } from 'lucide-react-native'
import { kindColor, radius, space, themes, type Theme } from '@cresco/mobile-shared/tokens'
